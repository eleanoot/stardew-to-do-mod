...
namespace ToDoMod
{
    class OptionsMenu : IClickableMenu
    {
        /*********
        ** Properties
        *********/
        ...
        *********/
        ...
        public OptionsMenu(int currentIndex, ModConfig config, Action saveConfig)
            : base(Game1.viewport.Width / 2 - (800 + IClickableMenu.borderWidth * 2) / 2,
                   Game1.viewport.Height / 2 - (800 + IClickableMenu.borderWidth * 2) / 2,
                   800 + IClickableMenu.borderWidth * 2,
                   200 + IClickableMenu.borderWidth * 2,
                   true)
        {
            this.Config = config;
